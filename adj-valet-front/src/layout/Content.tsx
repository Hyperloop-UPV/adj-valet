...
export const Content = ({ selectedSection, setSelectedSection }: Props) => {
    ...
    if (selectedSection === 'general_info') {
        return (
            <div className="h-full flex-1 bg-[radial-gradient(circle_at_top,_#ffffff,_#f6f5f1_60%)]">
                <GeneralInfoForm />
            </div>
        );
    } else {
        ...
        return (
            <div className="flex flex-wrap overflow-y-auto bg-[radial-gradient(circle_at_top,_#ffffff,_#f6f5f1_60%)]">
                <SimpleBoardForm
