...
function App() {
    ...
    const { loadConfig, setError, resetState, loadDemoConfig } =
        useADJActions();
        ...
        return (
            <div className="flex h-full w-full items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-600">
                        Failed to load the ADJ configuration.
                    </p>
                </div>
            </div>
        );
    ...
    return (
        <div className="flex h-full w-full">
            ...
            {isLoading && (
                <div className="border-border bg-card fixed top-6 right-6 rounded-lg border px-3 py-2 shadow-sm">
            ...
            {error && (
                <div className="border-destructive/30 bg-destructive/10 text-destructive fixed top-20 right-6 max-w-sm rounded-lg border px-4 py-3 text-sm shadow-sm">
                    {error}
                </div>
            )}
        </div>
